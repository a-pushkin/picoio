 ...
 *
 * Resets communication protocol. Can be used to recover communication if data
 ...
 */
struct Reset {
  static constexpr MessageId id = MessageId::Reset;

  static constexpr std::array<uint8_t, 16> reset_token_value{
